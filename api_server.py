"""
FastAPI REST Server & Operational Weather Command Console for SIH26081.

Exposes HTTP endpoints & Operational Dashboard:
- GET  /           : Operational Weather Forecast Command Center UI.
- POST /predict    : Dynamic forecast weighting, blending, calibrated bounds & IMD alerts.
- POST /predict/batch : Multi-station spatial forecasting across Indian grid points.
- GET  /export/report : Export official downloadable forecast bulletin CSV/JSON.
- GET  /diagnostics: Model feature importances, skill scores, and regime performance analytics.
- GET  /stations   : Operational Indian meteorological grid locations and live conditions.
- GET  /metrics    : Benchmark metrics manifest.
